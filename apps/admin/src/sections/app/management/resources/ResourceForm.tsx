    ...
    <div className="w-full mx-auto space-y-8">
      ...
      >
        ...
        <Form {...form}>
          ...
          >
            {/* Resource Name Field - Only show in edit mode */}
            {mode === 'edit' && initialData?.name && (
              <div className="space-y-2">
                <FormLabel>Resource Name (Read-only)</FormLabel>
                <Input
            ...
            {/* Resource Name Field - Only show in create mode */}
            {mode === 'create' && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Use lowercase with underscores (e.g., users, orders,
                      products)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
